...
manga = signal<MangaDto>(new MangaDto);
  ...
  constructor(private route: ActivatedRoute, private mangaService: MangaService,private router: Router, private sharedData: SharedDataService, public authService: AuthService) { }
